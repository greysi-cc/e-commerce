                                                    ...
                                                    <div class="table-p__box">
                                                        ...
                                                        <div class="table-p__info">
                                                            ...
                                                            <span class="table-p__name">
                                                                ...
                                                                <a href="index.php">Yellow Wireless Headphone</a></span>

                                                            <span class="table-p__category">

                                                                <a >Electronics</a></span>
                                                    ...
                                                    <div class="table-p__box">
                                                        ...
                                                        <div class="table-p__info">
                                                            ...
                                                            <span class="table-p__name">
                                                                ...
                                                                <a href="index.php">Rose Pink del Galaxy S8+</a></span>

                                                            <span class="table-p__category">

                                                                <a>Women Clothing</a></span>
                                                            <ul class="table-p__variant-list">
                                                                <li>
                                                    ...
                                                    <div class="table-p__box">
                                                        ...
                                                        <div class="table-p__info">
                                                            ...
                                                            <span class="table-p__name">
                                                                ...
                                                                <a >Hover Red Skateboard Scooter</a></span>

                                                            <span class="table-p__category">

                                                                <a >Men Clothing</a></span>
                                                            <ul class="table-p__variant-list">
                                                                <li>
                            ...
                            <div class="col-lg-12">
                                <div class="route-box">
                                    <div class="route-box__g1">
                                        ...
                                        <a class="route-box__link"><i class="fas fa-long-arrow-alt-left"></i>
